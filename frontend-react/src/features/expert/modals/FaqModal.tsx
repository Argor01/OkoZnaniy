        ...
        <div className={styles.faqModalSection}>
          ...
          <Collapse
            ...
            items={[
              {
                key: 'kb1',
                label: <Text className={styles.faqModalItemTitle}>Что такое «Око Знаний»?</Text>,
                children: (
                  <Text className={styles.faqModalItemText}>
                    «Око Знаний» — это образовательный сервис, который объединяет студентов и экспертов.
                    Студенты могут размещать заказы на выполнение учебных работ, а эксперты — выполнять их за вознаграждение.
                    Платформа обеспечивает безопасные сделки, систему арбитража и удобное взаимодействие между участниками.
                  </Text>
                ),
                className: styles.faqModalItem
              },
              {
                ...
                children: (
                  <Text className={styles.faqModalItemText}>
                    База Знаний — это раздел сервиса, где пользователи могут публиковать и находить полезные учебные материалы:
                    статьи, конспекты, примеры работ и другие образовательные ресурсы.
                    Статьи можно фильтровать по типу работы и предмету, а также искать по ключевым словам.
                  </Text>
                ),
                className: styles.faqModalItem
              },
              {
                key: 'kb3',
                label: <Text className={styles.faqModalItemTitle}>Как опубликовать статью в Базе Знаний?</Text>,
                children: (
                  <Text className={styles.faqModalItemText}>
                    Для публикации статьи перейдите в раздел «База Знаний» в боковом меню и нажмите кнопку «Написать статью».
                    Заполните название, описание, выберите тип работы и предмет, при необходимости прикрепите файлы.
                    После публикации статья станет доступна всем пользователям сервиса.
                  </Text>
                ),
                className: styles.faqModalItem
              },
              {
                key: 'kb4',
                label: <Text className={styles.faqModalItemTitle}>Как найти нужную статью в Базе Знаний?</Text>,
                children: (
                  <Text className={styles.faqModalItemText}>
                    Используйте строку поиска для поиска статей по ключевым словам.
                    Также вы можете отфильтровать статьи по типу работы (курсовая, дипломная, реферат и т.д.)
                    и по предмету. Это поможет быстро найти нужный учебный материал.
                  </Text>
                ),
                className: styles.faqModalItem
              },
              {
                key: 'kb5',
                label: <Text className={styles.faqModalItemTitle}>Можно ли пожаловаться на статью в Базе Знаний?</Text>,
                children: (
                  <Text className={styles.faqModalItemText}>
                    Да, если вы обнаружили статью с неприемлемым контентом, спамом, нарушением авторских прав
                    или недостоверной информацией, вы можете подать жалобу.
                    Администрация рассмотрит жалобу и примет соответствующие меры, вплоть до удаления статьи.
                  </Text>
                ),
                className: styles.faqModalItem
              },
              {
                key: 'kb6',
                label: <Text className={styles.faqModalItemTitle}>Что такое портал вопросов и ответов?</Text>,
                children: (
                  <Text className={styles.faqModalItemText}>
                    Портал вопросов и ответов — это раздел Базы Знаний, где пользователи могут задавать вопросы по учебным темам
                    и получать ответы от других участников сообщества.
                    Вопросы можно сортировать по категориям, а лучшие ответы отмечаются как решение.
                  </Text>
                ),
                className: styles.faqModalItem
              },
