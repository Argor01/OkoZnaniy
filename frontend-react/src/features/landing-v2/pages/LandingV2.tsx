    ...
    <div className={styles.container}>
      <div className={styles.footerDarkGrid}>
        ...
        <div className={styles.footerCol}>
          ...
          <a href="mailto:partners.okoznaniy@mail.ru">partners.okoznaniy@mail.ru</a>
          <a href="tel:+79314674652">+7 931 467-46-52</a>
        </div>
        <div className={styles.footerCol}>
...
const LandingV2: React.FC = () => {
  useEffect(() => {
    document.title = 'Око Знаний — Помощь студентам | Эксперты, гарантия, авторский подход';
  }, []);
  return (
    <div className={styles.page}>
      <SEO
        title="Око Знаний — Помощь студентам | Эксперты, гарантия, авторский подход"
