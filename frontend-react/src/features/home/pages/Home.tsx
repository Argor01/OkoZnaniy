  ...
  return (
    <div className={`page-wrapper ${landingStyles.landingPage}`}>
      <SEO 
        ...
        description="Сервис помощи студентам: быстро, надёжно, по выгодной цене. Разместите задание и получите помощь от профессиональных экспертов. Курсовые, дипломы, рефераты, контрольные работы."
        keywords="помощь студентам, написание работ, курсовые работы, дипломные работы, рефераты, контрольные работы, эссе, студенческие работы, заказать работу, помощь с учебой, консультации студентам"
        ogTitle="Око Знаний - Помощь студентам"
