...
import { Form, Input, InputNumber, Button, Card, Typography, message, Alert, Tag, Descriptions } from 'antd';
...
const ExpertApplication: React.FC = () => {
  ...
  const onFinish = async (values: any) => {
    setLoading(true);
    try {
      await authApi.submitExpertApplication(values);
      message.success('Анкета успешно подана! Мы рассмотрим её в ближайшее время.');
      // Обновляем страницу
      setTimeout(() => {
