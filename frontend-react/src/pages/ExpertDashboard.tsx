...
interface Notification {
  id: number;
  type: 'order' | 'claim' | 'forum' | 'question' | 'system' | 'message' | 'balance' | 'bid';
  title: string;
  message: string;
  timestamp: string;
  isRead: boolean;
...
const ExpertDashboard: React.FC = () => {
  ...
  const { notifications: dbNotifications, unreadCount: dbUnreadCount, markAsRead } = useNotifications();
  
  // Добавляем иконки к уведомлениям из БД
  const mockNotifications: Notification[] = dbNotifications.map(notif => {
    let icon;
    switch (notif.type) {
      case 'order':
      ...
      case 'bid':
        ...
        break;
      default:
        icon = <BellOutlined style={{ color: '#6b7280' }} />;
    }
    return { ...notif, icon };
  });
  ...
  return (
    ...
    <Layout style={{ minHeight: '100vh' }} className={styles.expertDashboardPage}>
      <Sidebar
        ...
        unreadNotifications={dbUnreadCount}
        userProfile={profile ? {
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <Collapse
              ...
              items={[
                {
                  key: '1',
                  label: <Text style={{ fontSize: 15, color: '#1f2937' }}>Как пользоваться сервисом ���������?</Text>,
                  children: (
                    <Text style={{ fontSize: 14, color: '#6b7280', lineHeight: 1.6 }}>
                      Сервис ��������� предназначен для помощи студентам в выполнении различных учебных заданий. 
                ...
                {
                  key: '2',
                  label: <Text style={{ fontSize: 15, color: '#1f2937' }}>Как разместить заказ на сервисе ���������?</Text>,
                  children: (
                    <Text style={{ fontSize: 14, color: '#6b7280', lineHeight: 1.6 }}>
                ...
                {
                  key: '3',
                  label: <Text style={{ fontSize: 15, color: '#1f2937' }}>Как взять заказ на выполнение на сервисе ���������?</Text>,
                  children: (
                    <Text style={{ fontSize: 14, color: '#6b7280', lineHeight: 1.6 }}>
                ...
                {
                  key: '7',
                  label: <Text style={{ fontSize: 15, color: '#1f2937' }}>Какие гарантии предоставляет сервис ��������� для своих пользователей?</Text>,
                  children: (
                    <Text style={{ fontSize: 14, color: '#6b7280', lineHeight: 1.6 }}>
                      Сервис ��������� гарантирует безопасность сделок через систему гарантий. 
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <Collapse
              ...
              items={[
                ...
                {
                  key: '13',
                  label: <Text style={{ fontSize: 15, color: '#1f2937' }}>Схема оплаты на сервисе ��������� ("Безопасная сделка")</Text>,
                  children: (
                    <Text style={{ fontSize: 14, color: '#6b7280', lineHeight: 1.6 }}>
              ...
              items={[
                {
                  ...
                  children: (
                    <Text style={{ fontSize: 14, color: '#6b7280', lineHeight: 1.6 }}>
                      На сервисе ��������� существует несколько типов пользователей: заказчик - размещает задания и оплачивает работы; 
                      специалист - выполняет заказы за вознаграждение; менеджер ��������� - персональный помощник по работе с сервисом; 
                ...
                {
                  key: '17',
                  label: <Text style={{ fontSize: 15, color: '#1f2937' }}>Кто такой менеджер ��������� (персональный менеджер)?</Text>,
                  children: (
                    <Text style={{ fontSize: 14, color: '#6b7280', lineHeight: 1.6 }}>
                      Персональный менеджер ��������� - это сотрудник сервиса, который помогает пользователям в работе с платформой. 
