...
export const CompletedRequestsSection: React.FC<CompletedRequestsSectionProps> = ({
  ...
  const mockRequests: CompletedRequest[] = [
    {
      id: 1,
      title: 'Проблема с оплатой заказа',
      description: 'Не могу оплатить заказ картой, выдает ошибку',
      type: 'billing',
      priority: 'high',
      user: {
        id: 101,
      ...
      completed_at: '2024-02-03T16:45:00Z',
      resolution: 'Проблема была в блокировке карты банком. Клиент связался с банком, блокировка снята. Заказ успешно оплачен.',
      resolution_type: 'resolved',
      satisfaction_rating: 5,
      satisfaction_comment: 'Очень быстро помогли разобраться с проблемой!',
      response_time_minutes: 15,
      total_time_minutes: 135,
      messages_count: 8,
      tags: ['платежи', 'банковская карта', 'быстрое решение'],
      related_order_id: 1234,
      follow_up_required: false,
    },
    {
      id: 2,
      title: 'Вопрос по качеству выполненной работы',
      description: 'Получил работу, но есть вопросы по оформлению',
      type: 'order',
      priority: 'medium',
      user: {
        id: 102,
        username: 'maria_vip',
        first_name: 'Мария',
        last_name: 'ВИП-клиент',
        email: 'maria@example.com',
        is_vip: true,
        registration_date: '2022-03-20T08:00:00Z',
        total_orders: 45,
        total_spent: 89500,
      },
      assigned_admin: {
      ...
      completed_at: '2024-02-03T09:30:00Z',
      resolution: 'Эксперт внес исправления в оформление работы согласно требованиям. Клиент остался доволен результатом.',
      resolution_type: 'resolved',
      satisfaction_rating: 4,
      satisfaction_comment: 'Хорошо, что исправили быстро',
      response_time_minutes: 45,
      total_time_minutes: 1330,
      messages_count: 12,
      tags: ['качество работы', 'оформление', 'VIP клиент'],
      related_order_id: 1235,
      follow_up_required: true,
      follow_up_date: '2024-02-10T10:00:00Z',
    },
  ];
