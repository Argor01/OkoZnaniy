  ...
  const mockClaims: Claim[] = [
    {
      ...
      title: 'Некачественное выполнение курсовой работы',
      description: 'Эксперт выполнил работу не по требованиям, много ошибок, не соответствует теме. Требую полный возврат средств.',
      claim_type: 'quality_issue',
      user: {
        id: 201,
        username: 'student_angry',
        first_name: 'Анна',
        last_name: 'Недовольная',
        email: 'anna.nedovolnaya@email.com',
        phone: '+7 (999) 123-45-67',
      },
      expert: {
        id: 301,
        username: 'expert_careless',
        first_name: 'Петр',
        last_name: 'Небрежный',
        email: 'petr.nebrezhny@email.com',
      ...
      assigned_admin: {
        ...
        first_name: 'Мария',
        last_name: 'Разбирательная',
      },
      deadline: '2024-02-06T23:59:59Z',
      actions: [
        {
          id: 1,
          action_type: 'investigation',
          description: 'Начато расследование претензии. Запрошены дополнительные материалы у обеих сторон.',
          performed_by: {
            id: 1,
            username: 'admin_claims',
            first_name: 'Мария',
          ...
          performed_at: '2024-02-01T15:00:00Z',
        },
        {
          id: 2,
          action_type: 'contact_expert',
          description: 'Связались с экспертом для получения объяснений по качеству работы.',
          performed_by: {
            id: 1,
            username: 'admin_claims',
            first_name: 'Мария',
          ...
          performed_at: '2024-02-02T11:30:00Z',
          notes: 'Эксперт согласился доработать работу',
        },
      ],
      evidence: [
        {
          id: 1,
          type: 'work_file',
          title: 'Оригинальная работа от эксперта',
          file_url: '/files/coursework_original.docx',
          uploaded_by: 'expert',
    ...
    },
    {
      ...
      title: 'Нарушение сроков выполнения заказа',
      description: 'Эксперт сдал работу с опозданием на 5 дней, из-за чего я не успел сдать в университет.',
      claim_type: 'deadline_violation',
      user: {
        id: 202,
        username: 'student_late',
        first_name: 'Игорь',
        last_name: 'Опоздавший',
        email: 'igor.opozdavshiy@email.com',
        phone: '+7 (999) 234-56-78',
      },
      expert: {
        id: 302,
        username: 'expert_slow',
        first_name: 'Елена',
        last_name: 'Медленная',
        email: 'elena.medlennaya@email.com',
      },
      order: {
        id: 1002,
      ...
      actions: [
        {
          id: 3,
          action_type: 'investigation',
          description: 'Проверены сроки заказа и факт нарушения дедлайна.',
          performed_by: {
            id: 2,
            username: 'admin_mediator',
            first_name: 'Сергей',
          ...
          performed_at: '2024-01-30T17:00:00Z',
        },
        {
          id: 4,
          action_type: 'contact_user',
          description: 'Связались с клиентом для уточнения ущерба от просрочки.',
          performed_by: {
            id: 2,
            username: 'admin_mediator',
            first_name: 'Сергей',
          ...
          performed_at: '2024-02-01T10:15:00Z',
        },
      ],
      evidence: [
        {
          id: 3,
          type: 'communication',
          title: 'Переписка о сроках',
          file_url: '/files/deadline_communication.pdf',
          uploaded_by: 'user',
          uploaded_at: '2024-01-30T16:50:00Z',
          verified: true,
        },
      ],
      messages_count: 12,
    ...
    },
    {
      ...
      title: 'Подозрение в плагиате',
      description: 'Работа содержит большие фрагменты, скопированные из интернета без указания источников.',
      claim_type: 'plagiarism',
      user: {
        id: 203,
        username: 'student_detector',
        first_name: 'Ольга',
        last_name: 'Внимательная',
        email: 'olga.vnimatelnaya@email.com',
      },
      expert: {
        id: 303,
        username: 'expert_copier',
        first_name: 'Алексей',
        last_name: 'Копировщик',
        email: 'alexey.kopirovshik@email.com',
      },
      order: {
        id: 1003,
      ...
      assigned_admin: {
        id: 3,
        username: 'admin_plagiarism',
        first_name: 'Анна',
        last_name: 'Антиплагиат',
      },
      ...
      actions: [
        {
          ...
          description: 'Проведена проверка работы на плагиат через систему Антиплагиат.',
          performed_by: {
            id: 3,
            username: 'admin_plagiarism',
            first_name: 'Анна',
          ...
          performed_at: '2024-02-02T12:00:00Z',
          notes: 'Обнаружено 65% заимствований без указания источников',
        },
      ],
      evidence: [
        {
          id: 4,
          type: 'work_file',
          title: 'Реферат с подозрением на плагиат',
          file_url: '/files/plagiarism_work.docx',
          uploaded_by: 'expert',
          uploaded_at: '2024-01-28T15:00:00Z',
          verified: true,
        },
        {
          id: 5,
          type: 'document',
          title: 'Отчет системы Антиплагиат',
          file_url: '/files/antiplagiat_report.pdf',
          uploaded_by: 'admin',
          uploaded_at: '2024-02-02T12:05:00Z',
          verified: true,
        },
      ],
      messages_count: 5,
