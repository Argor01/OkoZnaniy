export const API_ENDPOINTS = {
  ...
  orders: {
    ...
    acceptAssignment: (id: number) => `/orders/orders/${id}/accept_assignment/`,
    declineAssignment: (id: number) => `/orders/orders/${id}/decline_assignment/`,
  ...
  admin: {
    ...
    communication: {
      chatRooms: {
        ...
        join: (id: number) => `/admin-panel/chat-rooms/${id}/join_room/`,
        leave: (id: number) => `/admin-panel/chat-rooms/${id}/leave_room/`,
    ...
    support: {
      requests: {
        ...
        take: (id: number) => `/admin-panel/support-requests/${id}/take_request/`,
        complete: (id: number) => `/admin-panel/support-requests/${id}/complete_request/`,
      ...
      claims: {
        ...
        take: (id: number) => `/admin-panel/claims/${id}/take_in_work/`,
        complete: (id: number) => `/admin-panel/claims/${id}/complete_claim/`,
        reject: (id: number) => `/admin-panel/claims/${id}/reject_claim/`,
      ...
      chats: {
        ...
        messages: (id: number) => `/admin-panel/support-chats/${id}/send-message/`,
      },
    },
    arbitration: {
      cases: {
