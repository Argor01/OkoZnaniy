...
const faqData: FAQItem[] = [
  {
    ...
    answer: 'Да, все работы проходят обязательную проверку на плагиат с помощью современных сервисов. Мы гарантируем уникальность не менее 90%, и мы сделаем необходимую для вас оригинальность работы по требованиям вашего ВУЗа.'
  },
  {
    id: 2,
