...
**Статус:** ✅ сделано (доступ к карточке ограничен участниками, лента — безопасными полями)
...
**Статус:** ✅ сделано (скидки отключены в API и выдаче заказа)
...
**Статус:** ✅ сделано (разрешено принимать участникам чата, включая expert‑expert)
...
**Рекомендация:**
- Явно фиксировать допустимые роли/участников для сценариев, где expert‑expert недопустим.
