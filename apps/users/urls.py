...
urlpatterns = [
    ...
    path('all_users/', views.UserViewSet.as_view({'get': 'all_users'}), name='all_users'),
    path('my_friends/', views.UserViewSet.as_view({'get': 'my_friends'}), name='my_friends'),
    path('<int:pk>/add_friend/', views.UserViewSet.as_view({'post': 'add_friend'}), name='add_friend'),
    path('<int:pk>/remove_friend/', views.UserViewSet.as_view({'post': 'remove_friend'}), name='remove_friend'),
